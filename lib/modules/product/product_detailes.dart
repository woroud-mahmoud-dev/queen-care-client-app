            ...
            children: [
              Row(
                ...
                children: [
                   ...
                   Text(myService.getSelectedProduct!.name,style:  const TextStyle(fontSize: 18),),

                ],
              ),
              SizedBox(height: h*0.03,),
               Text(    myService.getSelectedProduct!.description,
                 style:  const TextStyle(height: 1.2,fontSize: 16,color: darkGrey),
