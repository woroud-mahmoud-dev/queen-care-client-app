...
class ProductScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Color btColor=myService.getSelectedProduct!.isfav==true?Colors.red:Colors.grey;
      ...
      child: BlocConsumer<ProductCubit, ProductState>(
        listener: (context, state) {
          ...
          if (state is AddToFavoriteSuccessState) {
            btColor =Colors.red;
            showToast(text: 'المنتج تمت اضافته إلى المفضلة ', color: Colors.green);
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          image: DecorationImage(
                              image: NetworkImage(imgUrlOLa +
                                  myService.getSelectedProduct!.image),
                              fit: BoxFit.contain)),
                    ),
                  ),
                  Expanded(
