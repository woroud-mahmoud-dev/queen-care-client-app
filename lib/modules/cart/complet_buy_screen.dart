...
class CompleteBuyScreen extends StatelessWidget {
  ...
  const CompleteBuyScreen({Key? key,
  }) : super(key: key);
              ...
              body:  Padding(
                ...
                child: ListView(
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: Text('المشتريات',style: TextStyle(color: kPrimaryColor,fontSize: 18),),
                          ),
                      ...
                      ) :  ShowCartProducts( allOrders: allProducts, numberOfItems: [2,3,4], amountsList: [],),
